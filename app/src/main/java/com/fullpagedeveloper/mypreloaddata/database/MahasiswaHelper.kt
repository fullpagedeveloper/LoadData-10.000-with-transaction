package com.fullpagedeveloper.mypreloaddata.database
...
import com.fullpagedeveloper.mypreloaddata.database.DatabaseContract.MahasiswaColumns.Companion.NAMA
import com.fullpagedeveloper.mypreloaddata.database.DatabaseContract.MahasiswaColumns.Companion.NIM
import com.fullpagedeveloper.mypreloaddata.database.DatabaseContract.TABLE_NAME
...
class MahasiswaHelper(context: Context) {
    ...
    //insert
    fun insertMahasiswa(mahasiswaModel: MahasiswaModel): Long {
    ...
    //load data dengan transactional
